...
export default class Editor {
  ...
  private drawSite() {
    ...
    this.ctx.arc(
      this.canvasCenter.x,
      this.canvasCenter.y,
      0, //SAM_PARAMS.MISSILE_MAX_DISTANCE / (this.scale * 2),
      0,
      2 * Math.PI,
    );
    this.ctx.stroke();
  ...
  addPoint(event: MouseEvent) {
    ...
    const currentPoint = {
      ...
      z: 0,//this.getFlightObjectType()!.altitude(),
      v: 0//this.getFlightObjectType()!.maxVelocity,
    };
  ...
  addFlightMission() {
    ...
    this.flightMissions.push({
      ...
      rcs: 0, // this.getFlightObjectType()!.rcs,
